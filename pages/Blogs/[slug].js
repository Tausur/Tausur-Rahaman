                ...
                {comments.map((comment) => {
                    if (comment.post == slug) {
                        return <div key={comment._id}>
                            <div className='w-3/4 h-full bg-gray-300 md:ml-32 rounded-xl md:mb-8 my-5 mx-5'>
                                <div className='flex  items-center'>
                                    <div className='bg-blue-500 text-lg rounded-full w-10 h-10 flex justify-center items-center text-white md:ml-8 md:my-8 mx-2 my-2'>
                                        {comment.name[0]}
                                    </div>
                                ...
                                <div className='text-xl font-semibold md:pl-20 md:pb-8 mx-2 my-2 pb-2'>
                                    {comment.body}
                                </div>
                            </div>
                        </div>
